...
#include "opencv_services/predicted_joints.h"
...
geometry_msgs::Point joints[3];

bool get_predicted_joints(opencv_services::predicted_joints::Request  &req,
    opencv_services::predicted_joints::Response &res) 
{
  joints[0].x = 1;
  joints[0].y = 0;
  joints[0].z = 0;
